...
function JobCard({ job, onClick }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-gray-500">{job.salaryRange} • {job.category}</p>
  ...
  return (
    <div className="bg-white p-3 rounded-xl shadow-md space-y-2">
      ...
      <div className="bg-white p-4 rounded-xl shadow space-y-4">
        <h2 className="text-lg font-semibold text-gray-800">Profile Insight</h2>
...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 pt-10">
      {/* Search */}
      <form className="w-full max-w-6xl mx-auto flex gap-2 mb-4" onSubmit={(e) => e.preventDefault()}>
        <input
          type="search"
  ...
  {/* Right Column: Scrollable Job Detail (Desktop only) */}
